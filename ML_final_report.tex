...
Among the ensemble methods, the soft--voting classifier improves over the single logistic model and yields an accuracy of \(0.892\), precision \(0.935\), recall \(0.879\) and F1--score \(0.906\). The confusion matrix
...
\begin{table}[h!]
    ...
    \begin{tabular}{@{}lc@{}}
        ...
        Soft Voting Ensemble              & $0.8918$ \\
        Hard Voting Ensemble              & $0.8745$ \\
        Bagging Ensemble                  & $0.8571$ \\
        Stacking Ensemble                 & $0.9203$ \\
        \bottomrule
    \end{tabular}
